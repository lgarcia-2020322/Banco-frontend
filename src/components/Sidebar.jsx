      ...
      <nav className="nav-links">
        ...
        {user?.role === 'ADMIN' && (
          <>
            ...
            <NavLink to="/dashboard/reports" className="nav-item">
              <div className="icon-wrapper">
                <img src="/src/assets/report.png" alt="Reports static" className="icon static" />
                <img src="/src/assets/report.gif" alt="Reports gif" className="icon gif" />
              </div>
              <span>Reports</span>
            </NavLink>
            ...
            <NavLink to="/dashboard/purchases" className="nav-item">
              <div className="icon-wrapper">
                <img src="/src/assets/compras.png" alt="Purchase static" className="icon static" />
                <img src="/src/assets/purchase.gif" alt="Purchase gif" className="icon gif" />
              </div>
              <span>Purchases</span>
            </NavLink>
        ...
        {user?.role === 'CLIENT' && (
          <>
            ...
            <NavLink to="/dashboard/movements" className="nav-item">
              <div className="icon-wrapper">
                <img src="/src/assets/intercambio.png" alt="Movement static" className="icon static" />
                <img src="/src/assets/movement.gif" alt="Movement gif" className="icon gif" />
              </div>
              <span>Movements</span>
            </NavLink>
